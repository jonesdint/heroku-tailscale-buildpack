...
#DGJ   log "Running `proxychains4 -f vendor/proxychains-ng/conf/proxychains.conf curl hello.ts.net` "
  log 'Things are working if you see <a href="https://hello.ts.net">Found</a>.'
#DGJ   proxychains4 -f vendor/proxychains-ng/conf/proxychains.conf curl hello.ts.net
curl hello.ts.net #DGJ ADDED
